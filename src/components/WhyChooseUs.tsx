        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-12 items-start">
          ...
          >
            ...
            <h2 className="font-display font-medium text-3xl sm:text-4xl text-ink leading-tight mb-5">
              ...
              <br />
              <span className="italic text-bottle">a small job.</span>
            </h2>
          ...
          >
            {reasons.map((reason, i) => (
              <motion.div
                ...
                className="flex items-center gap-3 bg-paper border border-ink/8 rounded-xl px-4 py-3.5"
              >
                <div className="w-6 h-6 rounded-full bg-bottle/10 flex items-center justify-center shrink-0">
                  <FiCheck className="text-bottle text-sm" />
                </div>
                <span className="text-ink font-medium text-sm">{reason}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
